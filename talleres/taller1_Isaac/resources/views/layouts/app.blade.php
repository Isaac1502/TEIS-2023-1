...
<head>
    ...
    <title>@yield('title', 'Parcial 01')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                <div class="navbar-nav ms-auto">
                    ...
                    <a class="nav-link active" href="{{ route('flight.create') }}">Register flights</a>
                    <a class="nav-link active" href="{{ route('flight.index') }}">List flights</a>
                    <a class="nav-link active" href="{{ route('flight.index') }}">Flight statistics</a>
                </div>
            </div>
        </div>
    </nav>
